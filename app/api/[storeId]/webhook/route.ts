...
//         if (paymentIntent.metadata) {
//           // Attach metadata to your processing logic
//           console.log("Metadata from PaymentIntent:", paymentIntent.metadata);

//           // Now you can send an API call or attach the metadata as needed
//         }
//       }

//       // Handle further logic for successful charge
//       break;
//     }
//     case "terminal.reader.action_succeeded": {
//       const terminalReaderActionSucceeded = event.data.object;
//       //   console.log("Terminal reader action was successful!", terminalReaderActionSucceeded);
//       // Handle logic for terminal reader action succeeded
//       break;
//     }
//     default:
